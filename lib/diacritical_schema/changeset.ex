defmodule DiacriticalSchema.Changeset do
  ...
  @doc """
  Hashes the value of a `changeset` change, `key`, onto `digest_key`.
  ...
  transformation, because the underlying message derivation is (necessarily)
  ...
  def validate_slug(changeset, key \\ :slug)
    ...
    |> Ecto.Changeset.validate_length(key, max: 128)
  end
end
