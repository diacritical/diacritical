defmodule Diacritical.Telemetry do
  ...
  def metrics() do
    [
      ...
      summary("swoosh.deliver.exception", unit: {:native, :millisecond}),
      summary("swoosh.deliver.start", unit: {:native, :millisecond}),
      summary("swoosh.deliver.stop", unit: {:native, :millisecond}),
      summary("swoosh.deliver_many.exception", unit: {:native, :millisecond}),
      summary("swoosh.deliver_many.start", unit: {:native, :millisecond}),
      summary("swoosh.deliver_many.stop", unit: {:native, :millisecond}),
